    ...
    public ResponseEntity<ShoppingCart> partialUpdateShoppingCart(
        ...
        Optional<ShoppingCart> result = shoppingCartRepository
            ...
            .map(existingShoppingCart -> {
                ...
                if (shoppingCart.getDrinkId() != null) {
                    existingShoppingCart.setDrinkId(shoppingCart.getDrinkId());
                }
                if (shoppingCart.getSugar() != null) {
                    existingShoppingCart.setSugar(shoppingCart.getSugar());
                }
                if (shoppingCart.getIce() != null) {
                    existingShoppingCart.setIce(shoppingCart.getIce());
                }
                if (shoppingCart.getToppings() != null) {
                    existingShoppingCart.setToppings(shoppingCart.getToppings());
                }
                if (shoppingCart.getDrinkSize() != null) {
                    existingShoppingCart.setDrinkSize(shoppingCart.getDrinkSize());
                }
