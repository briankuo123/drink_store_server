    ...
    public ResponseEntity<UserInfo> partialUpdateUserInfo(
        ...
        Optional<UserInfo> result = userInfoRepository
            ...
            .map(existingUserInfo -> {
                ...
                if (userInfo.getCreateBy() != null) {
                    existingUserInfo.setCreateBy(userInfo.getCreateBy());
                }
                if (userInfo.getCreateDatetime() != null) {
                    existingUserInfo.setCreateDatetime(userInfo.getCreateDatetime());
                }
                if (userInfo.getLastModifiedBy() != null) {
                    existingUserInfo.setLastModifiedBy(userInfo.getLastModifiedBy());
                }
                if (userInfo.getLastModifiedDatetime() != null) {
                    existingUserInfo.setLastModifiedDatetime(userInfo.getLastModifiedDatetime());
                }
